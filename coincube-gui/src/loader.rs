...
impl Loader {
    ...
    pub fn subscription(&self) -> Subscription<Message> {
        if self.internal_bitcoind.is_some() {
            ...
            iced::Subscription::run_with(log_path, make_bitcoind_log_stream)
...
fn make_bitcoind_log_stream(log_path: &PathBuf) -> impl Stream<Item = Option<String>> {
    get_bitcoind_log(log_path.clone())
}
